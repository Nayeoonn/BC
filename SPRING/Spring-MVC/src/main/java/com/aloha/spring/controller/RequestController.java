...
public class RequestController {
	...
	/**
	 * @RequestMapping : 요청 경로 매핑 - /request/board 로 요청 - /request/board.jsp 응답
	 * @return
	 */
...
//   @RequestMapping("/request/board")
	 ...
	 * @return
	 */
	@ResponseBody // form 태그에서 post 요청을 하므로
...
//   public String requestPost(@RequestParam("no") int data) {
	...
	/**
	 * 컨텐츠 타입 매핑 - Content-Type 헤더의 값으로 매핑 - consumes = "컨텐츠타입값"
	 * 
	 * @return
	 */
	@ResponseBody
	...
	/**
	 * Accept 매핑 - Accept 헤더의 값으로 매핑 ( Accept 헤더는 응답 받을 컨텐츠 타입을 지정 ) - produces =
	 * "컨텐츠타입값"
	 * 
	 * @return
	 */
...
//      logger.info("birth : " + birth);
	...
	/**
	 * Map 컬렉션으로 요청 파라미터 가져오기 요청경로 : /request/map?name=joeun&age=20
	 * 
	 * @param map
	 * @return
	 */
