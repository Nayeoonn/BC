...
DECLARE
      ...
      -- 상수명 CONSTANT 테이터타입 [DEFAULT 기본값] [NOT NULL, NULL];
      VI_NUM NUMBER; -- 선언부
      CO_NUM CONSTANT NUMBER = 200;     -- 상수선언
BEGIN
     VI_NUM := 100;     -- 실행부
     VI_NUM := 1000;
     -- CO_NUM := 2000; 상수는 값을 최초에 한 번만 초기화 하고 바꿀 수 없다.
...
-- 조회하여 1,000,000원 이상 2,000,000 이하면 1 출력
--         2,000,001원 이상 3,000,000 이하면 2출력
--         그렇지 않으면 3 출력 
DECLARE
      -- 지정된 부서 D1
...
--EXECUTE PRO_APP_EMP('200', 'SA_REP', '2023/01/01', '2025/01/01');
