...
class Student{
	...
	public boolean equals(Object obj) {
		// 두 객체가 의미상으로 일치ㅏ는지 여부를 true, false 반환
		if(this == obj)
			return true;
		
		// null 체크 - 비교 대상이 null인 경우 비교 자체가 불가
		// * NullPointerExcepiton 발생 가능
		if (obj == null) {
			return false;
		}
...
public class ObjectEquals {
	...
	public static void main(String[] args) {
		...
		// 학생1과 학생2의 레퍼런스 비교
		if (student == student2) {
			System.out.println("student 와 student2의 주소(래퍼런스)가 같습니다.");
		}
		else {
			System.out.println("student 와 student2의 주소(래퍼런스)가 다릅니다.");
		}
		System.out.println("============================");
		...
		// 학생1과 학생3의 레퍼런스 비교
		if (student == student3) {
			System.out.println("student 와 student3의 주소(래퍼런스)가 같습니다.");
		} else {
			System.out.println("student 와 student3의 주소(래퍼런스)가 다릅니다.");
		}
		System.out.println("============================");
