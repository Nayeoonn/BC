...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// 해당 리스트 컬렌셕으로부터 Iterator 객체를 가져와서 반복할 수 있다.
		...
		// - next()				: 다음 요소를 반환
		// 컬렌션객체.iterator()	: 해당 컬렌셕에 대한 iterator 객체 반환
		...
		System.out.println(vector);
		// - 삭제시 삭제한 위치 뒤의 index가 앞으로 한 칸씩 당겨진다.
								// 0	   1  	 2	   3	  4
		...
		// 컬렌션.isEmpty()  : 요소가 하나도 없으면 true, 비어있지 않으면 false
		if(vector.isEmpty()) {
