...
public class ComparatorEx {
	public static void main(String[] args) {
        ...
        userList.add(new User("aloha2024", "박조은", 27));
        userList.add(new User("thoeun11", "권조은", 27));
        userList.add(new User("hana96", "이조은", 30));
        userList.add(new User("hana96", "황조은", 24));
        userList.add(new User("hana96", "곽조은", 24));
